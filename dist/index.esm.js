...
const apiDef$2 = {
    ...
    GenerateConsoleCtrlEvent: [DTypes.BOOL, [DTypes.DWORD, DTypes.DWORD]],
...
if (process.arch === 'x64') {
    apiDef.GetWindowLongPtrW = [DTypes.LONG_PTR, [DTypes.HWND, DTypes.INT]];
}
...
export { BufferTypeFactory, index$3 as C, winmsg as CS, index$3 as Comctl32, winmsg as Constants, index$4 as DStructExt, index$2 as K, index$2 as Kernel32, index$1 as Ntdll, index as U, index as User32 };
