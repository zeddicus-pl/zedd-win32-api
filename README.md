This excelent update of win32-api package probably comes from https://github.com/TC-mSundaram - at least that guys is named the same as a contributor on npmjs.org... It's great, but there's something messed up the the .esm.js version and I had to do a minor modification to it so it works.
